//áëþð â äâà ïðîõîäè (ïî ãîðèçîíòàë³, ïî âåðòèêàë³)
//ðîçì³ð framebuffer = ðîçì³ð â³êíà
#include <iostream>
...
int main()
{
	...
	// vertices1 äëÿ çàâàíòàæåííÿ çîáðàæåííÿ â åêðàííèé áóôåð (ïîâîðîò + ìàñøòàá)
	GLfloat vertices1[] = {
	...
	//äëÿ îáðîáêè çîáðàæåíÿ  áåç ïîâîðîòó, áåç ìàñøòàáóâàííÿ
	GLfloat vertices[] = {
		// Positions            // Texture Coords
		 -1, -1, 		0.f, 0.f,
		 1, -1,  		1.f, 0.f,
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		{ //íåîáõ³äíî äëÿ intel hd grapfics
